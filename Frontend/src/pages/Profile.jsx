...
export default function Profile() {
  ...
  // Settings states (mocked with local states)
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50/50 px-4">
        <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-xl max-w-md w-full text-center">
          ...
          <p className="text-slate-500 mb-6">Please log in to view your profile and account settings.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-slate-50/50 pb-16 animate-fade-in text-left">
      ...
      <div className="bg-white border-b border-slate-200 py-12 px-4 sm:px-6 lg:px-8 mb-8 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-8 relative z-10">
          <div className="relative">
            <div className="w-28 h-28 rounded-full bg-gradient-to-tr from-indigo-600 to-purple-600 flex items-center justify-center text-4xl text-white font-bold shadow-xl shadow-indigo-600/20 border-4 border-white">
              {profileData.username.charAt(0).toUpperCase()}
            </div>
            <span className="absolute bottom-1 right-1 w-6 h-6 rounded-full bg-green-500 border-4 border-white"></span>
          </div>
          <div className="text-center md:text-left flex-grow">
            ...
            <p className="mt-2 text-slate-500 w-fit font-medium flex items-center gap-2 justify-center md:justify-start">
              <Mail size={16} className="shrink-0" /> {profileData.email}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Navigation Tabs */}
        <div className="flex border-b border-slate-200 mb-8 bg-white p-1.5 rounded-2xl border border-slate-200/50 shadow-sm w-fit gap-2">
          <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
          {/* Main Card Panel */}
          <div className="md:col-span-8 bg-white rounded-3xl border border-slate-200/60 shadow-xl overflow-hidden p-8">
            {activeTab === 'profile' ? (
              <div className="animate-fade-in">
                <h2 className="text-xl font-bold text-slate-800 mb-6 flex items-center gap-2">
                  <Sparkles size={20} className="text-indigo-600" /> Account Overview
                </h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
                  <div className="bg-slate-50 p-5 rounded-2xl border border-slate-100">
                    ...
                    <span className="text-lg font-bold text-slate-800">{profileData.username}</span>
                  </div>
                  <div className="bg-slate-50 p-5 rounded-2xl border border-slate-100">
                    <span className="text-xs font-bold text-slate-400 uppercase tracking-widest block mb-1">Email Address</span>
                    <span className="text-lg font-bold text-slate-800">{profileData.email}</span>
                  </div>
                  <div className="bg-slate-50 p-5 rounded-2xl border border-slate-100">
                ...
                {profileData.role !== 'Admin' && (
                  <div className="border-t border-slate-100 pt-6">
                    ...
                    <div className="bg-indigo-50/50 p-6 rounded-2xl border border-indigo-100/50 flex items-center justify-between">
                      <div>
                        <span className="text-sm font-semibold text-slate-600">Courses Enrolled</span>
                        <p className="text-xs text-slate-455 font-normal mt-0.5">Includes active, paused, and finished courses.</p>
                      </div>
              ...
              <div className="animate-fade-in">
                <h2 className="text-xl font-bold text-slate-800 mb-6 flex items-center gap-2">
                  <Settings2 size={20} className="text-indigo-600" /> Preferences
                </h2>
                ...
                <div className="flex flex-col gap-6 mb-8">
                  ...
                  <div className="flex items-center justify-between py-4 border-b border-slate-100">
                    <div>
                      ...
                      <p className="text-xs text-slate-500 mt-0.5 font-normal">Switch the user interface color profile to dark mode.</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between py-4 border-b border-slate-100">
                    <div>
                      ...
                      <p className="text-xs text-slate-500 mt-0.5 font-normal">Receive course updates and recommended schedules directly via email.</p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                        type="checkbox"
                  ...
                  <div className="flex items-center justify-between py-4">
                    <div>
                      <h3 className="font-bold text-slate-800 flex items-center gap-2">
                        <Bell size={18} className="text-indigo-600" /> Push Notifications
                      </h3>
                      <p className="text-xs text-slate-500 mt-0.5 font-normal">Allow browser instant desktop alerts for newly updated course content.</p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                        type="checkbox"
          ...
          <div className="md:col-span-4 bg-white/80 backdrop-blur-md p-6 rounded-3xl border border-slate-200/60 shadow-md">
            <h3 className="font-bold text-slate-855 flex items-center gap-2 mb-4">
              <Lock size={18} className="text-indigo-600" /> Security / Password
            </h3>
            <p className="text-xs text-slate-500 mb-6 font-normal">Change your account password securely. Please use a strong password.</p>
            ...
            <form onSubmit={handlePasswordReset} className="flex flex-col gap-4">
              <div>
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full h-11 mt-1 border border-slate-200 bg-slate-50/50 rounded-xl px-4 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all placeholder:text-slate-300"
                />
              </div>
